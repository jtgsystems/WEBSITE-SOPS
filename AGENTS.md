...
## Directory Guidance
- `sops/`: SOP source of truth; update the index or entry docs when lifecycle docs move.
...
- This repo behaves like a documentation/SOP library; update indexes, manifests, and cross-links when content moves, and avoid duplicating guidance that already has a canonical home.
